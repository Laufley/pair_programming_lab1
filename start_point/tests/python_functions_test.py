...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_volume_of_cube(self):
    length_of_sides_cubed = volume_of_cube(4)
    self.assertEqual( 64, length_of_sides_cubed)
    pass

  #Given a String, return the String reversed
  
  def test_reverse_string(self):
    mirrored_string = reverse_string("bananarama")
    self.assertEqual("amarananab", mirrored_string)
    pass
